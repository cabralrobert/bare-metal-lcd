...
void GPIOPinMuxSetup0(unsigned int offsetAddr, unsigned int padConfValue){
	HWREG(SOC_CONTROL_REGS + offsetAddr) = (padConfValue);
    HWREG(SOC_CONTROL_REGS + offsetAddr) |= CONTROL_CONF_SPI0_D0_CONF_SPI0_D0_RXACTIVE;
    HWREG(SOC_CONTROL_REGS + offsetAddr) &= ~(CONTROL_CONF_SPI0_D0_CONF_SPI0_D0_PUTYPESEL);
    HWREG(SOC_CONTROL_REGS + offsetAddr) &= ~(CONTROL_CONF_SPI0_D0_CONF_SPI0_D0_PUDEN);
